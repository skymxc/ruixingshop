...
function getGenericOpenAPI(cloud) {
    ...
    function callWXOpenAPI(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var displayAPIName, data, pairs, key, val, contentType, fileExtension, filename, valStr, pbMessage, callResult, result, wxResp, err, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                            ...
                            if (wxResp) {
                                if (wxResp.errorCode) {
                                    ...
                                    err = new error_1.CloudSDKError({
                                        ...
                                        errMsg: error_config_2.ERR_CODE[wxResp.errorCode],
                                    });
                                }
